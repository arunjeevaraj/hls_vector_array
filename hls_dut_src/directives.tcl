...
set_directive_interface -mode axis -register -register_mode both -depth 1536 "dut" frame_i
set_directive_interface -mode s_axilite -register "dut" trans_mat
set_directive_interface -mode axis -register -register_mode both -depth 1536 "dut" frame_o
